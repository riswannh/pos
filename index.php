    ...
    <body class="theme-red">
        ...
        <nav class="navbar">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">APLIKASI POINT OF SALE v1.0.1</a>
                </div>
                                            ...
                                            <a href="javascript:void(0);">
                                                ...
                                                <div class="progress">
                                                    <div class="progress-bar bg-purple" role="progressbar"
                                                        aria-valuenow="85" aria-valuemin="0" aria-valuemax="100" style="width: 92%">
                                                    </div>
                                                </div>
                                            </a>
                                        </li>
        ...
        <section>
            ...
            <aside id="leftsidebar" class="sidebar">
                    ...
                    <ul class="list">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                ...
                                <li>
                                    <a href="?page=barang">Produk</a>
                                </li>
                                <li>
                                    <a href="?page=diskon">Diskon</a>
                                </li>
                                <li>
                                    <a href="?page=pajak">Pajak</a>
                                </li>
                                <li>
                                    <a href="#">No. Meja</a>
                                </li>
                                <li>
                                    <a href="#">Jam Kerja / Shift Karyawan</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                ...
                <div class="legal">
                    <div class="copyright">
                        &copy; 2019 <a href="javascript:void(0);">Mufid POS</a>.
                    </div>
                    <div class="version">
            ...
            <div class="container-fluid">
                <div class="block-header">
                    ...
                    if ($page == "kategori") {
                        ...
                        if ($aksi == "detail") {
                            include "page/kategori/detail.php";
                        }
                    ...
                    if ($page == "diskon") {
                        if ($aksi == "") {
                            include "page/diskon/diskon.php";
                        }
                    
                        if ($aksi == "tambah") {
                            include "page/diskon/tambah.php";
                        }

                        if ($aksi == "ubah") {
                            include "page/diskon/ubah.php";
                        }

                        if ($aksi == "hapus") {
                            include "page/diskon/hapus.php";
                        }
                        ...
                        if ($aksi == "detail") {
                            include "page/diskon/detail.php";
                        }
                    ...
                    if ($page == "pajak") {
                        if ($aksi == "") {
                            include "page/pajak/pajak.php";
                        }
                    
                        if ($aksi == "tambah") {
                            include "page/pajak/tambah.php";
                        }

                        if ($aksi == "ubah") {
                            include "page/pajak/ubah.php";
                        }

                        if ($aksi == "hapus") {
                            include "page/pajak/hapus.php";
                        }
                    ...
                    if ($page == "pelanggan") {
                        ...
                        if ($aksi == "detail") {
                            include "page/pelanggan/detail.php";
                        }
